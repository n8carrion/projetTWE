...
//on lui donne un objet, ca permet de ne pas se poser de questions sur l'ordre des arguemnts
//mais aussi de pouvoir donner des valeurs optionnelles. 
...
console.log("Chargement librairie ajax.js (ajax, envoiRequete, traiteReponse) ok");
